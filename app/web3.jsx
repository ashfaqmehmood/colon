...
const redirectUrl =
  ...
  Constants.appOwnership == AppOwnership.Guest
    ...
    : Linking.createURL("auth", { scheme: "colon" });
// IMP END - Whitelist bundle ID

// IMP START - Dashboard Registration
const clientId =
  "BFp_GoRMSHV_6Dj5t9ztSBKRNfQvzQc21AVgYDs7zSD-0w06cJb00GypzJvv1WVcA3I53wK15SCIjCqch_0Bgww"; // get from https://dashboard.web3auth.io
...
// Usage
Alert.alert('Debug Info', JSON.stringify(await web3auth.userInfo(), null, 2));    setConsole("Signing message");
    // For ethers v5
    // const ethersProvider = new ethers.providers.Web3Provider(this.provider);
    const ethersProvider = new ethers.BrowserProvider(provider);
